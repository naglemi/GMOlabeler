...
if(opt$debug == TRUE){
  print(paste("DO NOT ASSUME for plates which we have no missing",
              "explant data that there are no missing explants", 
              "(update Aug 24, 2022)."))
  cat("\n")
...
if(opt$debug == TRUE){
  ...
  print(nrow(randomization_datasheet[!is.na(
    randomization_datasheet$portion_Callus),]))
  
  print(table(randomization_datasheet$Genotype_ID,
              randomization_datasheet$`Treatment name`))
}

ggplot(randomization_datasheet, aes(x=`Treatment name`,
                                    y=portion_Callus,
...
ggplot(randomization_datasheet, aes(x=`Treatment name`, y=portion_Shoot,
                                    group=`Treatment name`)) + 
  geom_boxplot(outlier.shape=NA,
               fill=randomColor(luminosity=c("bright")),
               color="white",
...
ggplot(randomization_datasheet, aes(x=`Treatment name`,
                                    y=portion_All_regenerated_tissue,
                                    group=`Treatment name`)) + 
  geom_boxplot(outlier.shape=NA,
               fill=randomColor(luminosity=c("bright")),
               color="white",
...
ggplot(randomization_datasheet, aes(x=`Treatment name`,
                                    y=portion_transgenic_All_regenerated_tissue,
                                    group=`Treatment name`)) + 
  geom_boxplot(outlier.shape=NA,
               fill=randomColor(luminosity=c("bright")),
               color="white",
...
ggplot(randomization_datasheet, aes(x=`Treatment name`, y=portion_All_tissue,
                                    group=`Treatment name`)) + 
  geom_boxplot(outlier.shape=NA,
               fill=randomColor(luminosity=c("bright")),
               color="white",
...
ggplot(randomization_datasheet, aes(x=`Treatment name`,
                                    y=portion_transgenic_All_tissue,
                                    group=`Treatment name`)) + 
  geom_boxplot(outlier.shape=NA,
               fill=randomColor(luminosity=c("bright")),
               color="white",
...
ggplot(randomization_datasheet, aes(x=`Treatment name`, y=portion_Callus,
                                    group=`Treatment name`)) + 
